 ...
 * 文件服务器
 * @deprecated 已废弃
 * 请使用 {@link com.aih.zpicturebackend.manage.upload.FilePictureUpload}
 * 或 {@link com.aih.zpicturebackend.manage.upload.UrlPictureUpload}
 */
@Deprecated // 表示已经废弃，不建议使用
@Service
@Slf4j
